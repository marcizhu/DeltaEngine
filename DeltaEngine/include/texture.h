...
namespace DeltaEngine {
	namespace Graphics {
		...
		private:
			...
			Types::byte* loadImage(const char* filename, Types::uint32* width, Types::uint32* height, Types::uchar8* bpp);

		public:
			DELTAENGINE_API Texture(Types::uint32 width, Types::uint32 height, Types::uchar8 bpp);
			...
			DELTAENGINE_API inline Types::uint32 getID() const { return textureID; }
