...
#define KB_MODIFIER_LEFT_CONTROL	1 << 0
#define KB_MODIFIER_LEFT_ALT		1 << 1
#define KB_MODIFIER_LEFT_SHIFT		1 << 2
#define KB_MODIFIER_RIGHT_CONTROL	1 << 3
#define KB_MODIFIER_RIGHT_ALT		1 << 4
#define KB_MODIFIER_RIGHT_SHIFT		1 << 5
